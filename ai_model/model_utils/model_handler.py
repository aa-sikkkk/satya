...
class ModelHandler:
    """
    Handler for managing different AI models.
    ...
    def __init__(self, model_path: str):
        ...
        self.current_model = "phi2"  # Default to Phi-2
    ...
    def get_answer(self, question: str, context: str) -> Tuple[str, float]:
        ...
        """
        try:
            return self.phi2_handler.get_answer(question, context)
    ...
    def get_hints(self, question: str, context: str) -> List[str]:
        ...
        """
        try:
            return self.phi2_handler.get_hints(question, context)
        except Exception as e:
    ...
    def get_available_models(self) -> List[str]:
        ...
        """
        return ["phi2"]  # Currently only Phi-2 is available 